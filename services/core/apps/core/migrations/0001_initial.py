    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, storage=core.models.site.OverwriteStorage(), upload_to=core.models.site.image_path, verbose_name='featured image')),
                ('fontawesome_site_icon', models.CharField(default='fas fa-tools', help_text="Get icon name from <a href='https://fontawesome.com/'>Font Awesome</a>.", max_length=255, verbose_name='fontawesome site icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_fr', models.TextField(blank=True, default='A short text to describe this very website.', help_text='A short text to describe this very website.', max_length=2048, null=True, verbose_name='description')),
                ('description_en', models.TextField(blank=True, default='A short text to describe this very website.', help_text='A short text to describe this very website.', max_length=2048, null=True, verbose_name='description')),
                ('image', models.CharField(blank=True, max_length=100, null=True, verbose_name='featured image')),
                ('fontawesome_site_icon', models.CharField(default='fas fa-tools', help_text="Get icon name from <a href='https://fontawesome.com/'>Font Awesome</a>.", max_length=255, verbose_name='fontawesome site icon')),
